...
export const selectTogglingUsers = (state) => state.users.togglingUsers;

// Verificar si un usuario específico está siendo toggled
export const selectIsUserToggling = (userId) => (state) => 
  state.users.togglingUsers[userId] || false;
