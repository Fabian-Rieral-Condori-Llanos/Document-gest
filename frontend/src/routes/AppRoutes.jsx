...
// Pages - Analytics Permissions (Admin)
import { AnalyticsPermissionsPage } from '../pages/AnalyticsPermissions';
  ...
  return (
    <Routes>
      ...
      >
        ...
        {/* ============================================ */}
        {/* PERMISOS DE ANALYTICS - Solo Admin */}
        {/* ============================================ */}
        <Route path="/analytics-permissions" element={
          <AdminOnly>
