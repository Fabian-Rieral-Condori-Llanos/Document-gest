    ...
    describe('Image CRUD operations', () => {
      ...
      it('Get Image', async () => {
        var response = await request(app).get(`/api/images/${imageId}`)
          ...
          expect(response.body.data.name).toBe('image1.png');
          expect(response.body.data.value).toBe('data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAAAAAAALAAAAAABAAEAAAICRAEAOw');
