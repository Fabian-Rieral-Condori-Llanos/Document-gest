module.exports = function(request, app) {
    describe('Application settings', () => {
      ...
      it('Get public settings', async () => {
          ...
          expect(response.status).toBe(200);
          expect(response.body.data).toEqual(defaultPublicSettings);
      })
      ...
      it('Edit settings', async () => {
        ...
        expect(response.status).toBe(200);
        expect(response.body.data).toEqual(fullModification);
        ...
        expect(response.body.data.reviews.public.mandatoryReview).toEqual(false);
        expect(response.body.data.reviews.public.minReviewers).toEqual(5);
        expect(response.body.data.report.private.imageBorderColor).toEqual("#123456");
    })
